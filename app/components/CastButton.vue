        ...
        >
          <g id="ic_cast0_black_24dp" sketch:type="MSArtboardGroup">
            <g id="ic_remove_circle_white_24dp" sketch:type="MSLayerGroup">
              <path
                class="cast-connecting-bar cast-connecting-bar-1"
                d="M1,18 L1,21 L4,21 C4,19.34 2.66,18 1,18 L1,18 Z"
                id="Path"
                fill="#ffffff"
  ...
  methods: {
    initializeCastApi: function() {
      ...
      let sessionRequest = new chrome.cast.SessionRequest(
        process.env.GOOGLE_CAST_APP_ID
      );
  ...
  computed: {
    ...
    connecting: {
      ...
      set(chromecastConnecting) {
        this.$store.commit('SET_CHROMECAST_CONNECTING', {
    ...
    receiverName: {
      ...
      set(receiverName) {
        ...
        this.$store.commit('SET_CHROMECAST_RECEIVER_NAME', {
          receiverName: doc.documentElement.textContent,
        });
      },
    },

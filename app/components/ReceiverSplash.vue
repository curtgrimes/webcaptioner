                        ...
                        <div class="row">
                            <div class="col-md-10 col-lg-9 mx-auto">
                                <div class="card bg-light">
                                    <div :class="minimized ? 'mh-0 card-header p-0 border-0 animate-all' : 'mh-210px card-header pb-0 animate-all'" style="overflow:hidden">
                                        <div class="row">
                                                ...
                                                <div v-else>
                                                    <h3 :class="minimized ? 'm-0 animate-all font-weight-normal' : 'animate-all font-weight-normal'" :style="{fontSize: minimized ? '1.6rem' : '2rem', marginTop: minimized ? '3px' : '0'}">
                                                        ...
                                                        <span v-else-if="minimized">
                                                            <div class="row">
                                                                <div class="col-8 text-muted" style="line-height:2.3rem">
                                                                ...
                                                                <div class="col-4 d-flex">
                                                                    <b-btn size="sm" @click="show = false" variant="outline-secondary" class="ml-auto close-btn-outer text-left text-secondary px-4">
                                                                        Close
                                                                        <div class="close-btn-inner-wrap" v-bind:style="{width: ((closeCountdownCurrentMs/closeCountdownMaxMs)*100) +'%'}">
                                                                            <b-btn size="sm" @click="show = false" variant="secondary" class="close-btn-inner border-0 px-3 text-left rounded-0">
                                                                                <span class="px-2">
                                                                                    Close
                                                                                </span>
                                                                            </b-btn>
                                            ...
                                            <div class="col-md-10 mx-auto">
                                                <div v-if="!message">
                                                    <transition name="expand">
                                                        <p v-show="!minimized" class="lead text-muted mb-0"><fa icon="circle-notch" spin class="mr-2" />You'll see captions soon.</p>
                                                    </transition>

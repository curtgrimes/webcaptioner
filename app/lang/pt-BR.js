export default {
  ...
  settings: {
    ...
    eventLog: {
      ...
      instructions: {
        i0: 'Reproduza o problema que você teve e copie esse log e {sendItToMeOnFacebook}. O log inclui o conteúdo da sua trancrição atual, se tiver. Você pode deixar esta página e continuar a usar o Web Captioner normalmente.',
        i1: 'Por motivos de desempenho, o registro será desativado automaticamente após {loggingDurationMinutes} minutos. Você ainda pode copiar o log mesmo depois que ele for desativado, desde que você não recarregue a página.',
        sendItToMeOnFacebook: 'envie pra mim no Facebook'
      },
      copyLog: 'Copiar Log',
    ...
    experiments: {
      ...
      description: 'Não se esqueça de ajudar e me dar opiniões sobre experimentos! Envie-me um e-mail para {email} ou {messageMeOnFacebook}.',
      messageMeOnFacebook: 'me mande mensagem no Facebook',
      addExperimentConfirmation: 'Deseja adicionar o experimento "{experimentName}"?',
      addExperiment: 'Adicionar experimento',
      experimentName: 'Nome do experimento',
      alreadyAdded: 'Você já adicionou o experimento "{alreadyAddedExperimentName}".',
    ...
    appearance: {
      ...
      interimTextColorDescription: 'Durante as legendas, as palavras que acabaram de ser reconhecidas podem mudar um pouco, enquanto o Web Captioner determina o contexto da frase. Essas palavras serão mostradas nesta cor.',
      ...
      properNounsDescription: 'Frases separadas são detectadas somente quando uma pontuação tipo "ponto final" ou "ponto de interrogação" são ditos literalmente em voz alta.',
    ...
    controls: {
      ...
      larger: 'Maior',
      largerDescription: 'Controles maiores e botões adicionais para salvar e limpar a transcrição com um só clique',
    ...
    language: {
      ...
      spokenDescription: {
        text: 'O Web Captioner reconhecerá a fala nesse idioma. Saiba mais sobre {supportedLanguagesAndDialects}.',
    ...
    vmix: {
      vmix: 'vMix',
      description: {
        text: '{vMix} é um software misturador e switcher de vídeo popular. Você pode enviar texto diretamente para o vMix e exibi-lo em uma entrada de título. Você pode usar os controles de fonte e cor do vMix para estilizar o texto das legendas. {visitTheHelpCenter} para saber mais.',
        visitTheHelpCenter: 'Visite o centro de ajuda'
      },
      connectedToVmix: 'Conectado ao vMix!',
      connected: 'Conectado',
      captionsWillAppear: '{startCaptioning} e suas legendas aparecerão agora no vMix.',
      ...
      installChromeExtensionDescription: 'A extensão do Web Captioner Connector para o Google Chrome permite que o Web Captioner se conecte ao vMix.',
      ...
      enableVmixWebControllerInstructions: 'No vMix, vá para {settingMenu}. Marque a caixa para ativar o {webController}. Especifique um número de porta ou aceite a padrão.',
      enableVmixWebControllerSettingMenu: 'Configurações > Controlador da Web',
      provideAddress: 'Forneça o endereço que aparece no vMix:',
      example: 'Exemplo:',
      cannotConnect: 'Não é possível conectar-se ao vMix em "{webControllerAddress}". Lembre-se de que o Web Controller esteja ativado no vMix e que você tenha copiado o endereço do site corretamente. Deve ser algo mais ou menos assim: http://192.168.1.1:8080',
      import: 'Importar',
      importTitleTemplate: 'Importar modelo de template',
      webCaptionerTitleTemplate: 'Modelo de título Web Captioner',
      importTitleTemplateLonger: 'Importar o modelo de título do Web Captioner para o vMix',
      importTitleTemplateInstructions: {
        ...
        i2: 'Na janela {inputSelect}, clique em {browse} no canto superior direito e abra o modelo de título do Web Captioner que você baixou.',
        i3: 'O título aparecerá na guia {recent}. Clique duas vezes nela.',
        i4: 'No editor de títulos que aparece, opcionalmente, personalize o tamanho da fonte e do texto. Feche quando terminar.'
      },
      cantFindTemplate: 'O Web Captioner pode se conectar ao vMix, mas não pode encontrar o modelo de título do Web Captioner em uma entrada.',
    ...
    exportRestore: {
      ...
      restore: 'Restaurar',
      restoreDescription: 'Restaure as configurações (aparência, configurações do censor, substituições de palavras, configurações do vMix etc.) de um arquivo de configurações que você exportou e salvou anteriormente.',
      ...
      export: 'Exportar',
      exportDescription: 'Suas configurações serão salvas como um arquivo JSON.'
    }
  },
  incompatibleBrowser: {
    incompatibleBrowser: 'Navegador incompatível',
    message: {
      i0: 'Desculpe, mas atualmente o Web Captioner só funciona no Google Chrome.',
      i1: 'Ainda é possível explorar opções e fuçar com as configurações, mas para começar as legendas, você terá que {switchToGoogleChrome}.',
      i2: 'Se a compatibilidade com navegadores que não sejam o Chrome for importante pra você, {castAVoteHere}.',

<template>
  <div class="settings-language-view">
    ...
    <div class="list-group">
      <router-link tag="button" v-for="locale in $i18n.locales.filter((locale) => {return locale.code == 'en-US'})" v-bind:key="locale.code" :to="switchLocalePath(locale.code)" class="list-group-item list-group-item-action p-2" v-bind:class="{'active': locale.code === $i18n.locale}">
        <span class="row m-0">

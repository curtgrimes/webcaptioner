<template>
  <div class="settings-appearance-view">
    ...
    <form-group-input
      :label="$t('settings.appearance.textColor')"
      v-model="textColor"
      type="color"
    />

    <form-group-input
      :label="$t('settings.appearance.textColorInterim')"
      v-model="textColorInterim"
      type="color"
      :hint="$t('settings.appearance.interimTextColorDescription')"
    />
    <div class="row">
    ...
    <form-group-input
      :label="$t('settings.appearance.letterSpacing')"
      ...
      <div class="col-6">
        ...
        <div class="btn-group btn-group-toggle d-flex flex-wrap">
          <label
            ...
            v-bind:class="{ active: alignmentHorizontal == 'full' }"
          >
            <input
              v-model="alignmentHorizontal"
              type="radio"
              name="horizontal-alignment"
              id="horizontal-alignment-full"
              value="full"
              autocomplete="off"
              checked
            />
          ...
          <label
            class="btn btn-primary btn-block text-left p-2 m-0 w-50"
            v-bind:class="{ active: alignmentHorizontal == 'left' }"
          >
            <input
              v-model="alignmentHorizontal"
              type="radio"
          ...
          <label
            class="btn btn-primary btn-block text-left p-2 m-0 w-50"
            v-bind:class="{ active: alignmentHorizontal == 'middle' }"
          >
            <input
              v-model="alignmentHorizontal"
              type="radio"
          ...
          <label
            class="btn btn-primary btn-block text-left p-2 m-0 w-50"
            v-bind:class="{ active: alignmentHorizontal == 'right' }"
          >
            <input
              v-model="alignmentHorizontal"
              type="radio"
        ...
        <div class="btn-group btn-group-toggle d-flex flex-wrap">
          <label
            class="btn btn-primary btn-block text-left p-2 m-0 w-50"
            v-bind:class="{ active: alignmentVertical == 'full' }"
          >
            <input
              v-model="alignmentVertical"
              type="radio"
          ...
          <label
            class="btn btn-primary btn-block text-left p-2 m-0 w-50"
            v-bind:class="{ active: alignmentVertical == 'top' }"
          >
            <input
              v-model="alignmentVertical"
              type="radio"
          ...
          <label
            class="btn btn-primary btn-block text-left p-2 m-0 w-50"
            v-bind:class="{ active: alignmentVertical == 'middle' }"
          >
            <input
              v-model="alignmentVertical"
              type="radio"
          ...
          <label
            class="btn btn-primary btn-block text-left p-2 m-0 w-50"
            v-bind:class="{ active: alignmentVertical == 'bottom' }"
          >
            <input
              v-model="alignmentVertical"
              type="radio"
          ...
          <label
            class="btn btn-primary btn-block text-left p-2 m-0 w-50"
            v-bind:class="{ active: alignmentVertical == 'lowerThird' }"
    ...
    <form-group-input
      :label="$t('settings.appearance.backgroundOpacity')"
    ...
    <form-group-input
      ...
      min="0"
      step="1"
      append-input-text="px"
    />

    <form-group-input
      :label="$t('settings.appearance.xPosition')"
    ...
    <form-group-input
      :label="$t('settings.appearance.yPosition')"
    ...
    textColor: {
      ...
      set: debounce(
        function(textColor) {
          ...
          if (
            this.$store.state.settings.appearance.text.textColor ===
            this.$store.state.settings.appearance.text.textColorInterim
          ) {
            this.$store.commit('SET_TEXT_COLOR_INTERIM', {
              textColorInterim: textColor,
            });
          }

          if (
            this.$store.state.settings.appearance.text.textColor != textColor
          ) {
    ...
    shadowColor: {
      ...
      set: debounce(
        function(shadowColor) {
          if (
            this.$store.state.settings.appearance.shadow.color != shadowColor
          ) {

      ...
      <div class="row">
        ...
        <div class="col-4 col-lg-3 bg-white border-left my-n3">
          <div class="sticky-top py-3">
            ...
            <b-form-group label="Maximum lines per group" class="small">
              <b-form-input
            ...
            <b-form-group label="Maximum characters per line" class="small">
              <b-form-input
    ...
    srt() {
      ...
      for (let i = 0; i < this.stabilizedTranscript.length; i++) {
        ...
        if (
          ...
          for (let j = 0; j <= thisLineGroup.length; j++) {
            if (!thisLineGroup[j] && j < this.linesPerGroup) {
              // This line needs to be initialized
              thisLineGroup[j] = [];
            }

            if (j >= this.linesPerGroup) {
      ...
      for (let i = 0; i < lineGroups.length; i++) {
        ...
        if (this.format === 'srt') {
          ...
          output += '\n';
        } else if (this.format === 'webvtt') {
          if (i === 0) {
            // First iteration
            output += `WEBVTT Kind: captions${
